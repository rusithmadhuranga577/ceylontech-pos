...
<section class="content-header content-header-custom">
    <img class="col-lg-3 col-md-4 col-xs-4 col-4" src="{{ asset( 'uploads/business_logos/' . Session::get('business.logo') ) }}" alt="Logo">
        ...
        @if($is_admin)
    	   ...
    	   <div class="row" style="justify-content: space-between;">
                <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                   <div class="info-box-sqre-style" style="background-color:#00cc0a;">
                        <div class="info-box-circle-style" style="background-color:#00cc0a;">
                            <i class="ion ion-ios-cart" style="font-size:32px;color:#ffffff;"></i>
                        </div>
                        <div style="padding-top: 50px;text-align: center;">
                          <span class="info-box-text" style="color:#FFFFFF;">{{ __('home.total_sell') }}</span>
                          <span class="info-box-number total_sell"><i class="fas fa-sync fa-spin fa-fw"></i></span>
                        </div>
                   </div>
                </div>
                
                <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                   <div class="info-box-sqre-style" style="background-color:#00a65a;">
                        <div class="info-box-circle-style" style="background-color:#00a65a">
                            <i class="ion ion-ios-paper" style="font-size:32px;color:#ffffff;"></i>
                        </div>
                        <div style="padding-top: 50px;text-align: center;">
                          <span class="info-box-text" style="color:#FFFFFF;">{{ __('lang_v1.net') }} @show_tooltip(__('lang_v1.net_home_tooltip'))</span>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                    <div class="info-box-sqre-style" style="background-color:#f39c12;">
                        <div class="info-box-circle-style" style="background-color:#f39c12">
                            <i class="ion ion-ios-paper" style="font-size:32px;color:#ffffff;"></i>
                        </div>
                        <div style="padding-top: 50px;text-align: center;">
                          <span class="info-box-text" style="color:#FFFFFF;">{{ __('home.invoice_due') }}</span>
    	    ...
    	    <!-- /.col -->
          	...
          	<div class="row" style="justify-content: space-between;">
          	    ...
          	    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
          	        <div class="info-box-sqre-style" style="background-color:#00c0ef;">
                        <div class="info-box-circle-style" style="background-color:#00c0ef">
                            <i class="ion ion-cash" style="font-size:32px;color:#ffffff;"></i>
                        </div>
                        <div style="padding-top: 50px;text-align: center;">
                          <span class="info-box-text" style="color:#FFFFFF;">{{ __('home.total_purchase') }}</span>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                    <div class="info-box-sqre-style" style="background-color:#c249ff;">
                        <div class="info-box-circle-style" style="background-color:#c249ff">
                            <i class="fa fa-exclamation" style="font-size:32px;color:#ffffff;"></i>
                        </div>
                        <div style="padding-top: 50px;text-align: center;">
                          <span class="info-box-text" style="color:#FFFFFF;">{{ __('home.purchase_due') }}</span>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                    <div class="info-box-sqre-style" style="background-color:#dd4b39;">
                        <div class="info-box-circle-style" style="background-color:#dd4b39">
                            <i class="fas fa-minus-circle" style="font-size:32px;color:#ffffff;"></i>
                        </div>
                        <div style="padding-top: 50px;text-align: center;">
                          <span class="info-box-text" style="color:#FFFFFF;">{{ __('lang_v1.expense') }}</span>
